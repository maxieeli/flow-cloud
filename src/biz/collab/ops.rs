...
use database_entity::dto::{
    AFCollabMember, CollabMemberIdentify, DeleteCollabParams,
...
pub async fn get_collab_member(
    ...
    params.validate()?;
    let collab_member = database::collab::select_collab_member(&params.uid, &params.object_id, pg_pool).await?;
    Ok(collab_member)
}
